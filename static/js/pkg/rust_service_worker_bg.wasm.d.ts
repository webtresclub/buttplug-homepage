...
export function __wbg_results_free(a: number): void;
export function results_nonce(a: number, b: number): void;
export function results_hash(a: number, b: number): void;
export function results_new(a: number, b: number, c: number, d: number): number;
export function crack(a: number, b: number, c: number, d: number, e: number): number;
