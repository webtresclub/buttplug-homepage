...
<main class="container">
	<section class="bg-white dark:bg-gray-900">
		<div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
			...
			>
				Here you can claim your Buttpluggy without mine it, but you must have been preselected (by
				having at least <a
					href="https://github.com/webtresclub/huffplug/tree/main/merkletree-builder#readme"
					class="underline text-blue-500 hover:text-blue-900"
					target="_blank">two community poaps</a
			...
			<div class="mt-6 p-4 mx-auto text-center font-mono"></div>
		</div>
	</section>
</main>
